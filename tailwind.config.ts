	...
	theme: {
		extend: {
			colors: {
				...
				'blue-slate-mid-dark': 'rgb(var(--palette-blue-slate-mid-dark) / <alpha-value>)',
				'blue-slate-deep': 'rgb(var(--palette-blue-slate-deep) / <alpha-value>)',
				...
				'dark-grey': 'rgb(var(--palette-dark-grey) / <alpha-value>)',
