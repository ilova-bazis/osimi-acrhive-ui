<script lang="ts">
	...
	const fields = [
		{ label: 'Language', value: 'Persian' },
		{ label: 'Document type', value: 'Newspaper scan' }
	];
	const badges = [
...
<section class="mx-auto flex min-h-[60vh] max-w-4xl flex-col gap-6 px-6 py-16">
	<header>
		...
		<h1 class="font-display text-3xl text-burnt-peach">FileOverridePanel</h1>
		<p class="mt-2 text-sm text-text-muted">Per-file override block.</p>
	</header>
	<FileOverridePanel
